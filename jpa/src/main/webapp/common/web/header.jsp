		...
		<div class="row">
			...
			<div class="col-md-6 col-sm-6 additional-nav">
				<ul class="list-unstyled list-inline pull-right">
					...
					<a href="${pageContext.request.contextPath}/createAccount">Signup</a>
							</c:when>
							<c:otherwise>
								<a href="${pageContext.request.contextPath}/home"> <c:out
										value="${sessionScope.account.first_name}"></c:out>
								</a> |
